...
function  handleSubmit(e) {
    ...
    if (!numberInp.value) {
        ...
        numberInp.parentElement.classList.add("errorCardNumber");
    } else {
        numberInp.classList.remove("error");
        numberInp.parentElement.classList.remove("errorCardNumber");
    }
    if (!monthInp.value) {
...
numberInp.addEventListener("keyup", setCardNumber);//? keyup event listener in javascript
